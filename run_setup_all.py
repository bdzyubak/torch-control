...
def main(envs_list=None):
    ...
    path_ymls = Path(__file__).parent
    ...
    for env_name in envs:
        ...
        conda_create_from_yml(env_name=env_name, file=path_ymls / envs[env_name]['install_method'])
        conda_extend_env(env_name=env_name, file=path_ymls / "environment_shared.yml")
